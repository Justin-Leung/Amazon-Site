...
;(function($, window, undefined) {
  ...
  $.fn.hideseek = function(options) {
    ...
    return this.each(function() {
      ...
      if ($this.opts.hidden_mode) $list.children().fadeTo('fast', 0.15);
        ...
        if (e.keyCode != 38 && e.keyCode != 40 && e.keyCode != 13 && ( e.keyCode != 8 ? $this.val().length >= $this.opts.min_chars : true ) ) {
          ...
          $list.children($this.opts.ignore.trim() ? ":not(" + $this.opts.ignore + ")" : '').removeClass('selected').each(function() {
            ...
            if (treaty) {
              ...
              $this.opts.highlight ? $(this).removeHighlight().highlight(q).fadeTo('fast', 1) : $(this).fadeTo('fast', 1);
          ...
          if ($this.opts.nodata) {
            ...
            if (!$list.children(':not([style*="opacity: 0.15"])').length) {
          ...
          if ($this.opts.headers) {
            $($this.opts.headers, $list).each(function() {
              if (!$(this).nextUntil($this.opts.headers).not('[style*="opacity: 0.15"],' + $this.opts.ignore).length) {
                $(this).fadeTo('fast', 0.15);
              } else {
                $(this).fadeTo('fast', 1);
              }
